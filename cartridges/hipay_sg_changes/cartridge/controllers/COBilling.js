...
function resetPaymentForms() {
    ...
    if (!empty(sitePrefs.hipayEnabled) && sitePrefs.hipayEnabled) {
        return require('*/cartridge/scripts/lib/hipay/modules/hipayCheckoutModule').resetPaymentForms();
    }
    /* HiPay custom code - end */
...
function validateBilling() {
    /* HiPay custom code - start */
    if (!empty(sitePrefs.hipayEnabled) && sitePrefs.hipayEnabled) {
        return require('*/cartridge/scripts/lib/hipay/modules/hipayCheckoutModule').validateBilling();
    }
    /* HiPay custom code - end */
