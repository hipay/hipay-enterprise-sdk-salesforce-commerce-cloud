...
var HiPayLogger   = require('*/cartridge/scripts/lib/hipay/hipayLogger'),
    HiPayConfig   = require('*/cartridge/config/hipayConfig').HiPayConfig,
...
HiPayCheckoutModule.hiPayOrderRequest = function(paymentInstrument, order, deviceFingerprint, recurring) {
    var PaymentTransaction = require('dw/order/PaymentTransaction'),
        ...
        status             = require('*/cartridge/config/hipayStatus').HiPayStatus,
    ...
    try {
        ...
        var TEMPrequest = JSON.stringify(params, undefined, 2);
